...
const { addAddress, getAddress, deleteAddress, updateUser, uploadUserImage, getUser, getUserById, getAllArtist, getAllUser, getAllArtistExceptLogger } = require('../controller/userController')
